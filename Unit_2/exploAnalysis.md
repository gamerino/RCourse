...
<p><img src="https://github.com/gamerino/RCourse/blob/master/Imagenes/boxplotMelanoma.png?raw=true" alt="Figura2"></p>
...
<p><img src="https://github.com/gamerino/RCourse/blob/master/Imagenes/barplotMelanoma.png?raw=true" alt="Figura6"></p>
<p><em><strong>Figura 6</strong></em>: <em>Gráfico de barras para la variable cualitativa <code style="font-family: Menlo, Consolas, &quot;DejaVu Sans Mono&quot;, monospace;">ocean</code> de la base de datos USmelanoma.</em></p>
...
<p><img src="https://github.com/gamerino/RCourse/blob/master/Imagenes/pieMelanoma.png?raw=true" alt="Figura7"></p>
<p><em><strong>Figura 7</strong></em>: <em>Gráfico de tortas para la variable cualitativa <code style="font-family: Menlo, Consolas, &quot;DejaVu Sans Mono&quot;, monospace;">ocean</code> de la base de datos USmelanoma.</em></p>
...
<h3>2.4.4 Descripción multivariada</h3>
...
<h4>2.4.4.1 Relaciones entre variables cuantitativas</h4>
...
<p><img src="https://github.com/gamerino/RCourse/blob/master/Imagenes/dispMelanoma.png?raw=true" alt="Figura8"></p>
<p><em><strong>Figura 8</strong></em>: <em>Gráfico de dispersión de la variable Mortalidad contra las variables latitud y longitud.</em></p>
<p><strong>Ejercicio</strong>: Discuta las gráficas. Explore la función <code style="font-family: Menlo, Consolas, &quot;DejaVu Sans Mono&quot;, monospace;">pairs()</code></p>
...
<h4>2.4.4.2 Relaciones entre variables cuantitativas y cualitativas</h4>
...
<p><img src="https://github.com/gamerino/RCourse/blob/master/Imagenes/boxplotMelanomaMortOcean.png?raw=true" alt="Figura9"></p>
<p><em><strong>Figura 9</strong></em>: <em>Diagrama de cajas de la variable Mortalidad en cada una de las categorías de la variable Océano.</em></p>
...
<p><img src="https://github.com/gamerino/RCourse/blob/master/Imagenes/dispMelanoma2.png?raw=true" alt="Figura10"></p>
<p><em><strong>Figura 10</strong></em>: <em>Gráfico de dispersión de la variable Mortalidad contra las variables latitud y longitud, incluyendo información de la variable Océano.</em></p>
<p><strong>Ejercicio</strong>: Discuta las gráficas.</p>
<h4>2.4.4.3 Relaciones entre variables cualitativas</h4>
...
<h2>2.5 La librería <code style="font-family: Menlo, Consolas, &quot;DejaVu Sans Mono&quot;, monospace;">ggplot2</code></h2>
...
<h3>2.5.1 Por qué usar <code style="font-family: Menlo, Consolas, &quot;DejaVu Sans Mono&quot;, monospace;">ggplot2</code></h3>
...
<h3>2.5.2 Creando gráficos en <code style="font-family: Menlo, Consolas, &quot;DejaVu Sans Mono&quot;, monospace;">ggplot2</code></h3>
...
<p><img src="https://github.com/gamerino/RCourse/blob/master/Imagenes/dispGGplot.png?raw=true" alt="Figura11"></p>
<p><em><strong>Figura 11</strong></em>: <em>Gráfico de dispersión de las variables mortalidad y latitud construído con <code style="font-family: Menlo, Consolas, &quot;DejaVu Sans Mono&quot;, monospace;">ggplot2</code>.</em></p>
<h3>2.5.3 Mapeo entre variables y propiedades gráficas</h3>
...
<p><img src="https://github.com/gamerino/RCourse/blob/master/Imagenes/dispGGplotShape.png?raw=true" alt="Figura12"></p>
<p><em><strong>Figura 12</strong></em>: <em>Gráfico de dispersión de las variables mortalidad y latitud, clasificados según la variable océano, construído con <code style="font-family: Menlo, Consolas, &quot;DejaVu Sans Mono&quot;, monospace;">ggplot2</code>.</em></p>
...
<p><img src="https://github.com/gamerino/RCourse/blob/master/Imagenes/dispGGplotshapecolor.png?raw=true" alt="Figura13"></p>
<p><em><strong>Figura 13</strong></em>: <em>Gráfico de dispersión de las variables latitud y longitud, clasificados según la variable océano y coloreados según el rango de mortalidad observada.</em></p>
...
<h3>2.5.4 Uso de <em>facets</em></h3>
...
<p><img src="https://github.com/gamerino/RCourse/blob/master/Imagenes/dispGGplotfacet.png?raw=true" alt="Figura14"></p>
<p><em><strong>Figura 14</strong></em>: <em>Gráfico de dispersión de las variables latitud y longitud, coloreados según el rango de mortalidad observada y presentados en dos <code style="font-family: Menlo, Consolas, &quot;DejaVu Sans Mono&quot;, monospace;">facets</code> según los valores de la variable océano.</em></p>
...
<p><img src="https://github.com/gamerino/RCourse/blob/master/Imagenes/dispGGplotFacet2.png?raw=true" alt="Figura15"></p>
<p><em><strong>Figura 15</strong></em>: <em>Gráfico de dispersión de las variables latitud y longitud, faceteados según los valores de la variable océano y los grupos de mortalidad definidos previamente.</em></p>
<h3>2.5.5 Objetos geométricos</h3>
...
<p><img src="https://github.com/gamerino/RCourse/blob/master/Imagenes/geomsGGplot.png?raw=true" alt="Figura16"></p>
<p><em><strong>Figura 16</strong></em>: <em>Diferentes gráficos generados a partir de los mismos datos para x e y. En la izquierda, diagrama de dispersión de las variables mortalidad y latitud. En la derecha, recta de regresión y bandas de confianza.</em></p>
...
<p><img src="https://github.com/gamerino/RCourse/blob/master/Imagenes/loesGGplot.png?raw=true" alt="Figura17"></p>
<p><em><strong>Figura 17</strong></em>: <em>Recta de regresión y bandas de confianza para la mortalidad en función de la latitud en los grupos rodeado y no por océano.</em></p>
...
<p><img src="https://github.com/gamerino/RCourse/blob/master/Imagenes/smoothGGlpotDisp.png?raw=true" alt="Figura18"></p>
<p><em><strong>Figura 18</strong></em>: <em>Recta de regresión con bandas de confianza y diagrama de dispersión para la mortalidad en función de la latitud en los grupos rodeado y no por océano.</em></p>
...
<p><img src="https://github.com/gamerino/RCourse/blob/master/Imagenes/smothGG2.png?raw=true" alt="Figura19"></p>
<p><em><strong>Figura 19</strong></em>: <em>Recta de regresión con bandas de confianza y diagrama de dispersión para la mortalidad en función de la latitud en los grupos rodeado y no por océano.</em></p>
...
<h3>2.5.6 Transformaciones estadísticas</h3>
...
<p><img src="https://github.com/gamerino/RCourse/blob/master/Imagenes/visualization-stat-bar.png?raw=true" alt="Figura20"></p>
<p><em><strong>Figura 20</strong></em>: <em>Ilustración del proceso de transformación estadística utilizado por <code style="font-family: Menlo, Consolas, &quot;DejaVu Sans Mono&quot;, monospace;">geom_bar()</code>.</em></p>
...
<p><img src="https://github.com/gamerino/RCourse/blob/master/Imagenes/barplotGG.png?raw=true" alt="Figura21"></p>
<p><em><strong>Figura 21</strong></em>: <em>Diagrama de barras para la variable océano.</em></p>
...
<p><img src="https://github.com/gamerino/RCourse/blob/master/Imagenes/statBinGG.png?raw=true" alt="Figura22"></p>
<p><em><strong>Figura 22</strong></em>: <em>Diagrama de barras para la variable mortalidad.</em></p>
...
<p><img src="https://github.com/gamerino/RCourse/blob/master/Imagenes/barplotGG3.png?raw=true" alt="Figura23"></p>
<p><em><strong>Figura 23</strong></em>: <em>Diagrama de barras para la variable mortalidad categorizada a cuatro intervalos definidos por los cuartiles.</em></p>
...
<h3>2.5.7 Sistemas de coordenadas</h3>
...
<p><img src="https://github.com/gamerino/RCourse/blob/master/Imagenes/boxplotHoriz.png?raw=true" alt="Figura24"></p>
<p><em><strong>Figura 24</strong></em>: <em>Diagrama de cajas para la variable mortalidad para los dos grupos de estados, definidos por la variable océano.</em></p>
...
<p><img src="https://github.com/gamerino/RCourse/blob/master/Imagenes/poalrGG.png?raw=true" alt="Figura25"></p>
<p><em><strong>Figura 25</strong></em>: <em>Diagrama de barras en coordenadas polares para la variable océano.</em></p>
<h3>2.5.8 Escalas y leyendas</h3>
...
<h4>2.5.8.1 Control de escala en los ejes x/y</h4>
...
<p><img src="https://github.com/gamerino/RCourse/blob/master/Imagenes/scalesDisp.png?raw=true" alt="Figura26"></p>
<p><em><strong>Figura 26</strong></em>: <em>Diagrama de dispersión mortalidad vs latitud con ajuste de escalas.</em></p>
...
<p><img src="https://github.com/gamerino/RCourse/blob/master/Imagenes/boxplotScales.png?raw=true" alt="Figura27">
1
<em><strong>Figura 27</strong></em>: <em>Diagrama de cajas para la variable mortalidad, agrupando los estados según la variable océano y con ajuste de escalas.</em></p>
<h4>2.5.8.2 Control de escala de colores/formas/tamaños</h4>
...
<p><img src="https://github.com/gamerino/RCourse/blob/master/Imagenes/boxplotScales2.png?raw=true" alt="Figura28"></p>
<p><em><strong>Figura 28</strong></em>: <em>Diagrama de cajas para la variable mortalidad, agrupando los estados según la variable océano y con ajuste de escalas gráficas.</em></p>
...
<h4>2.5.9.1 Temas predefinidos</h4>
...
<p><img src="https://github.com/gamerino/RCourse/blob/master/Imagenes/themeGG.png?raw=true" alt="Figura29"></p>
<p><em><strong>Figura 29</strong></em>: <em>Diagrama de violín para la variable mortalidad, agrupando los estados según la variable océano y con ajuste de escalas gráficas y de tema.</em></p>
...
<p><img src="https://github.com/gamerino/RCourse/blob/master/Imagenes/visualization-themes.png?raw=true" alt="Figura30"></p>
<p><em><strong>Figura 30</strong></em>: <em>Temas definidos en <code style="font-family: Menlo, Consolas, &quot;DejaVu Sans Mono&quot;, monospace;">ggplot2</code>.</em></p>
...
<h4>2.5.9.2 Creando temas propios</h4>
...
<p><img src="https://github.com/gamerino/RCourse/blob/master/Imagenes/themeGG2.png?raw=true" alt="Figura31"></p>
<p><em><strong>Figura 31</strong></em>: <em>Diagrama de violín para la variable mortalidad, agrupando los estados según la variable océano y con ajuste de escalas gráficas y de tema personalizado.</em></p>
...
<p><img src="https://github.com/gamerino/RCourse/blob/master/Imagenes/themeGG3.png?raw=true" alt="Figura32"></p>
<p><em><strong>Figura 32</strong></em>: <em>Diagrama de violín para la variable mortalidad, agrupando los estados según la variable océano y con ajuste de escalas gráficas y sin leyendas.</em></p>
...
<p><img src="https://github.com/gamerino/RCourse/blob/master/Imagenes/themeGG4.png?raw=true" alt="Figura33"></p>
<p><em><strong>Figura 33</strong></em>: <em>Diagrama de violín para la variable mortalidad, agrupando los estados según la variable océano y con ajuste de escalas gráficas y conservando sólo la leyenda para la latitud.</em></p>
<h3>2.5.10 Agregado de títulos y etiquetas</h3>
...
<p><img src="https://github.com/gamerino/RCourse/blob/master/Imagenes/themeGG5.png?raw=true" alt="Figura34"></p>
<p><em><strong>Figura 34</strong></em>: <em>Función de densidad estimada de la variable mortalidad, agrupando los estados según la variable océano.</em></p>
<h3>2.5.11 Guardar gráficos</h3>
...
<h2>2.6 Análisis Exploratorio con ggplot2</h2>
...
<h3>2.6.1 Exploración de las variables en forma independiente</h3>
...
<h3>2.6.2 Exploración multivariada</h3>
...
<p><img src="https://github.com/gamerino/RCourse/blob/master/Imagenes/epilepsy4.png?raw=true" alt="Figura35"></p>
<p><em><strong>Figura 35</strong></em>: <em>Diagrama de violin de la edad de los pacientes para los dos grupos experimentales.</em></p>
...
<p><img src="https://github.com/gamerino/RCourse/blob/master/Imagenes/epilepsy1.png?raw=true" alt="Figura36"></p>
<p><em><strong>Figura 36</strong></em>: <em>Diagrama de cajas del número de ataques registrados durante el tratamiento, en los cuatro períodos comprendidos y para los dos grupos experimentales.</em></p>
...
<p><img src="https://github.com/gamerino/RCourse/blob/master/Imagenes/epilepsy2.png?raw=true" alt="Figura37"></p>
<p><em><strong>Figura 37</strong></em>: <em>Diagrama de líneas y puntos para el número de ataques registrados durante el tratamiento, en los cuatro períodos comprendidos.</em></p>
...
<p><img src="https://github.com/gamerino/RCourse/blob/master/Imagenes/epilepsy3.png?raw=true" alt="Figura38"></p>
<p><em><strong>Figura 38</strong></em>: <em>Diagrama de dispersión del número de ataques registrados  previos y durante el tratamiento, en los cuatro períodos comprendidos.</em></p>
...
<p><img src="https://github.com/gamerino/RCourse/blob/master/Imagenes/epilepsy5.png?raw=true" alt="Figura39"></p>
<p><em><strong>Figura 39</strong></em>: <em>Diagrama de dispersión del número de ataques registrados  previos al experimento y la edad de los pacientes.</em></p>
<p><img src="https://github.com/gamerino/RCourse/blob/master/Imagenes/epilepsy6.png?raw=true" alt="Figura40"></p>
<p><em><strong>Figura 40</strong></em>: <em>Diagrama de dispersión del número de ataques registrados   durante el tratamiento y la edad de los pacientes, en los cuatro períodos comprendidos.</em></p>
